...
namespace Craft
{
    ...
    {
        //둘중 하나라도 null이 아니거나 활성화 되지 않은 상태라면 테스트 할 필요가 없음
        ...
        // x의 크기와 y의 크기를 고려해 박스를 구성하고 두 박스가 서로 겹치는지 확인하는 방법
        ...
        //이게 진짜 액터가 왼쪽 오른쪽에 있다는 게 아니라 그냥 두 액터를 지칭한 것임
        ...
        // 여기까지 온거면 충돌이 발생할 수 없는 조건을 다 통과한 것이기 때문에 충돌 발생했다고 판정.
        return true;
    }
}